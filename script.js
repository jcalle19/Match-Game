function createNewCard() {
  ...
  let inner = '<div class="card-down"></div><div class="card-up"></div>';
  cardElement.innerHTML = inner;
...
function incrementCounter(counterName, parentElement) {
  ...
  parentElement.innerHTML = String(counters[counterName]);
}
...
function onCardFlipped(newlyFlippedCard) {
  ...
  let flipC = document.getElementById("flip-count");
  let matchC = document.getElementById("match-count");
  incrementCounter("flips", flipC);
  ...
  if (lastCardFlipped == null) {
    ...
    return;
  } else if (!doCardsMatch(newlyFlippedCard, lastCardFlipped)) {
  ...
  incrementCounter("matches", matchC);
